...
class Camd {
  ...
  parseDetailpage(url, resp) {
    ...
    obj.name = $('#main > div.pagecenter > div > div > div > div > div.col10.last.right > h1.entry-title').text()
    ...
    obj.title = $('#main > div.pagecenter > div > div > div > div > div.col10 > p.introp').text()
    ...
    let email = $('#main > div.pagecenter > div > div > div > div:nth-child(1) > div.col5 > p > a').text()
  ...
  async main() {
    ...
    // let resp = await request.get('https://camd.northeastern.edu/journalism/people/jonathan-kaufman/')
    // let resp = await request.get('https://camd.northeastern.edu/artdesign/people/ann-mcdonald/')
    // this.parseDetailpage(resp)
    // return;
