...
class Home extends React.Component {
  constructor(props) {
    ...
    this.searchPageVisible = searchPageVisible || false;
  }
  ...
  componentDidMount() {
    ...
    //this.state = localStorage.getItem('prevState');
    console.log('state', this.state);
    console.log('this.searchPageVisible', this.searchPageVisible);
    console.log('prevState', window.sessionStorage.getItem('prevState'));
  ...
  render() {
    ...
    return (
      <div className={ containerClassnames }>
        ...
        { !this.searchPageVisible && <img src={ logo } className='logo' alt='logo' onClick={ this.onLogoClick } />}
        {this.searchPageVisible && (
        <TopSearchBar
