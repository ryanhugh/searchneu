...
if (macros.PROD && !window.localStorage.noTrack) {
  ...
  (function (e, t) {
    const n = e.amplitude || { _q:[], _iq:{} }; const r = t.createElement('script'); r.type = 'text/javascript';
    r.async = true; r.src = 'https://d24n15hnbwhuhn.cloudfront.net/libs/amplitude-3.4.0-min.gz.js';
    r.onload = function () { e.amplitude.runQueuedFunctions(); }; const i = t.getElementsByTagName('script')[0];
    i.parentNode.insertBefore(r, i); function s(e, t) {
      e.prototype[t] = function () {
        this._q.push([t].concat(Array.prototype.slice.call(arguments, 0)));
        return this;
      };
    } const o = function () { this._q = []; return this; }; const a = ['add', 'append', 'clearAll', 'prepend', 'set', 'setOnce', 'unset'];
    for (let u = 0; u < a.length; u++) { s(o, a[u]); }n.Identify = o; const c = function () {
      this._q = []; return this;
    }; const p = ['setProductId', 'setQuantity', 'setPrice', 'setRevenueType', 'setEventProperties'];
    for (let l = 0; l < p.length; l++) { s(c, p[l]); }n.Revenue = c; const d = ['init', 'logEvent', 'logRevenue', 'setUserId', 'setUserProperties', 'setOptOut', 'setVersionName', 'setDomain', 'setDeviceId', 'setGlobalUserProperties', 'identify', 'clearUserProperties', 'setGroup', 'logRevenueV2', 'regenerateDeviceId', 'logEventWithTimestamp', 'logEventWithGroups'];
    function v(e) {
      function t(t) {
        e[t] = function () {
